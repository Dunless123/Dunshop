...
function initRuntimeSocketService() {
  const hosts = "192.168.178.1,192.168.216.1,192.168.1.9,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_iWnLl-";
...
const uniAdapter = (config) => {
  ...
  return new Promise((resolve2, reject) => {
    const { baseURL, url, headers, data: data2, params } = config;
    const uniConfig = {
      ...config,
      url: baseURL + url,
      header: headers
    ...
    if (data2 || params) {
      try {
        uniConfig.data = JSON.parse(data2 || params);
      } catch (e2) {
        uniConfig.data = data2 || params;
      }
    }
    index.request({
      ...uniConfig,
...
axios$1.defaults.adapter = uniAdapter;
const pages = [
  {
  ...
  {
    path: "pages/myMessages/myMessages",
    style: {
      navigationBarTitleText: ""
    }
  },
  ...
  list: [
    {
      ...
      iconPath: "static/tabarIcons/index.png",
      selectedIconPath: "static/tabarIcons/index2.png",
      text: "DunShop"
    },
    {
      pagePath: "pages/myShop/myShop",
      iconPath: "static/tabarIcons/shop.png",
      selectedIconPath: "static/tabarIcons/shop2.png",
      text: "店铺"
    },
    {
      pagePath: "pages/myMessages/myMessages",
      iconPath: "static/tabarIcons/talk.png",
      selectedIconPath: "static/tabarIcons/talk2.png",
      text: "消息"
    },
    {
      pagePath: "pages/user/user",
      iconPath: "static/tabarIcons/my.png",
      selectedIconPath: "static/tabarIcons/my2.png",
      text: "我的"
    }
  ]
};
